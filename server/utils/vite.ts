...
export async function setupVite(app: Express, server: Server) {
  // Dynamically import vite functions with a different name to avoid circular import
  const viteLib: any = await import("vite");
  console.log("Available vite properties:", Object.keys(viteLib));
  
  const createServer = viteLib['createServer'];
  ...
  // Use simple logger instead of vite's createLogger
